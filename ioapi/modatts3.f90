...
MODULE MODATTS3
        ...
        !!-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
        !! Version "$Id: modatts3.f90 164 2015-02-24 06:50:01Z coats $"
...
'$Id:: modatts3.f90 164 2015-02-24 06:50:01Z coats                                $'
...
CONTAINS    !!-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
    ...
    LOGICAL FUNCTION SETCMAQA( FNAME, DUMMYATT )
        ...
        CHARACTER*24, PARAMETER :: PNAME = 'MODATTS3/SETCMAQA'
    ...
    LOGICAL FUNCTION SETSMOKEC( FNAME )
        ...
        CHARACTER*24, PARAMETER :: PNAME = 'MODATTS3/SETSMOKE'
