#.........................................................................
# VERSION "$Id: Makefile.cpl.sed 196 2015-06-18 13:50:15Z coats $"
...
DEFINEFLAGS = IOAPI_DEFS $(ARCHFLAGS) $(PARFLAGS)

VFLAG  = -DVERSION='3.0-cpl'
...
M90SRC = modgctp.f90 modatts3.f90
...
clean:  ${OBJDIR}
	cd ${OBJDIR}; rm $(fOBJ); rm $(FOBJ); rm $(COBJ) $(OOBJ); \
        rm ${LIB} ${MOBJ} ${MODS}
